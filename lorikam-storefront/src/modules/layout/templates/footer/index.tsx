  ...
  return (
    <footer className="border-t border-ui-border-base w-full">
      <div className="content-container flex flex-col w-full">
        ...
        <div className="flex flex-col small:flex-row w-full mb-8 pt-6 border-t border-ui-border-base gap-2 justify-between text-ui-fg-muted">
          <Text className="txt-compact-small">
            © {new Date().getFullYear()} Lorikam. Toate drepturile rezervate.
          </Text>
        </div>
      </div>
    </footer>
